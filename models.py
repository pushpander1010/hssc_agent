...
class Question(BaseModel):
    ...
    explanation:Optional[str] = Field(default=None, description="Small explanation for the answer") 
...
class ModelState(BaseModel):
    ...
    model: Optional[str] = Field(default="google|gemini-2.5-flash", description="model used to generate questions") 
